...
export interface MewTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface MewToken extends BaseContract {
  connect(runner?: ContractRunner | null): MewToken;
  waitForDeployment(): Promise<this>;

  interface: MewTokenInterface;
  ...
  buy: TypedContractMethod<[amount: BigNumberish], [void], "payable">;
